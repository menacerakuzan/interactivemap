...
const CANONICAL_POINT_TYPES = [
  ...
  { code: 'cafe', labelUk: 'Кафе', labelEn: 'Cafe', color: '#A16207', markerFile: 'cafe.svg' },
  { code: 'restaurant', labelUk: 'Ресторан', labelEn: 'Restaurant', color: '#9A3412', markerFile: 'restaurant.svg' },
  {
    code: 'administration',
  ...
  },
  {
    ...
    color: '#1E3A8A',
    markerFile: 'social_services.svg',
  },
  { code: 'shelter', labelUk: 'Укриття', labelEn: 'Shelter', color: '#334155', markerFile: 'shelter.svg' },
  { code: 'medical', labelUk: 'Мед заклад', labelEn: 'Medical', color: '#BE123C', markerFile: 'medical.svg' },
  { code: 'pharmacy', labelUk: 'Аптека', labelEn: 'Pharmacy', color: '#B12B2B', markerFile: 'pharmacy.svg' },
  { code: 'education', labelUk: 'Освіта', labelEn: 'Education', color: '#1D4ED8', markerFile: 'education.svg' },
  { code: 'sport', labelUk: 'Спорт', labelEn: 'Sport', color: '#166534', markerFile: 'sport.svg' },
  { code: 'culture', labelUk: 'Культура', labelEn: 'Culture', color: '#6D28D9', markerFile: 'culture.svg' },
  {
    code: 'hairdresser',
    labelUk: 'Перукарня',
    labelEn: 'Hairdresser',
    color: '#7E22CE',
    markerFile: 'hairdresser.svg',
  },
  ...
  { code: 'bank', labelUk: 'Банк', labelEn: 'Bank', color: '#C5A059', markerFile: 'bank.svg' },
  { code: 'post', labelUk: 'Пошта', labelEn: 'Post', color: '#0E7490', markerFile: 'post.svg' },
  { code: 'fuel_station', labelUk: 'АЗС', labelEn: 'Fuel Station', color: '#0B2545', markerFile: 'fuel_station.svg' },
  { code: 'street', labelUk: 'Вулиці', labelEn: 'Street', color: '#3D5263', markerFile: 'crossing.svg' },
  { code: 'square', labelUk: 'Площі', labelEn: 'Square', color: '#3D5263', markerFile: 'crossing.svg' },
  { code: 'park', labelUk: 'Парк', labelEn: 'Park', color: '#15803D', markerFile: 'park.svg' },
  { code: 'playground', labelUk: 'Дитячий майданчик', labelEn: 'Playground', color: '#0369A1', markerFile: 'playground.svg' },
  { code: 'hotel', labelUk: 'Готель', labelEn: 'Hotel', color: '#2B6CB0', markerFile: 'hotel.svg' },
  { code: 'other', labelUk: 'Інше', labelEn: 'Other', color: '#64748B', markerFile: 'social_services.svg' },
];
...
const POINT_TYPE_MARKER_FILE = {
  ...
  ...Object.fromEntries(
    Object.entries(LEGACY_POINT_TYPE_ALIAS).map(([legacyCode, canonicalCode]) => [
      legacyCode,
      POINT_TYPE_META_BY_CODE.get(canonicalCode)?.markerFile || 'social_services.svg',
    ])
  ),
};
const DEFAULT_POINT_MARKER_FILE = 'social_services.svg';
